...
static void usage(const string& prog)
{
	...
	cout << "\tgen sig e.g.: " << prog << " gen_without_expire ec_key.pem sig 1400000000 xiaojun" << endl;
	cout << "\tgen sig: " << prog << " gen pri_key_file sig_file sdkappid identifier" << endl;
	cout << "\tgen sig e.g.: " << prog << " gen ec_key.pem sig 1400000000 xiaojun" << endl;
	cout << "\tgen sig: " << prog << " genexpire pri_key_file sig_file sdkappid identifier expiredtime" << endl;
	cout << "\tgen sig e.g.: " << prog << " genexpire ec_key.pem sig 1400000000 xiaojun 31536000" << endl;
	cout << "\tgen sig: " << prog << " genuser pri_key_file sig_file sdkappid identifier expire userbuf" << endl;
	cout << "\tgen sig e.g.: " << prog << " genuser ec_key.pem sig 1400000000 xiaojun 1024 abc" << endl;
	cout << "\tgen2 sig: " << prog << " gen2 key sig_file sdkappid identifier" << endl;
	cout << "\tgen2 sig: " << prog << " gen2 5bd2850fff3ecb11d7c805251c51ee463a25727bddc2385f3fa8bfee1bb93b5e sig 1400000000 xiaojun" << endl;
	cout << "\tgen2user sig: " << prog << " gen2user key sig_file sdkappid identifier userbuf" << endl;
	cout << "\tgen2user sig: " << prog << " gen2user 5bd2850fff3ecb11d7c805251c51ee463a25727bddc2385f3fa8bfee1bb93b5e sig 1400000000 xiaojun abc" << endl;

	cout << "\tverify sig: " << prog << " verify pub_key_file sig_file sdkappid identifier" << endl;
	cout << "\tverify sig e.g.: " << prog << " verify public.pem sig 1400000000 xiaojun" << endl;
...
static int gen2_sig_with_userbuf(const string& key, const string& sig_file,
		uint32_t sdkappid, const string& identifier, const string& userbuf)
{
	string sig;
	string err_msg;
	int ret = gen_sig_v2_with_userbuf(sdkappid, identifier, key,
...
static int verify2_sig_with_userbuf(const string& key, string& sig_file,
    ...
    cout << "verify sig ok" << endl;
    cout << "expire " << expire_time << " init time " << init_time
         << " userbuf " << userbuf << endl;
    return 0;
}
...
int main(int argc, char * argv[]) {
    ...
    } else if (0 == strcmp(cmd, "gen2user") && 7 == argc) {
        std::string key = argv[2];
        std::string sig_file = argv[3];
        std::string sdkappid_str = argv[4];
        std::string identifier = argv[5];
        std::string userbuf = argv[6];
        ret = gen2_sig_with_userbuf(key, sig_file,
